...
Perhaps the easiest way to get started is by leveraging a Developer Token provided by the [API Explorer's](https://app.apiexplorer.rocks) token redemption service. See [Developer Tokens](/docs/data_lake/learn/developer_tokens) for details.
